...
final medicalplaceOrderProvider = Provider((ref) =>
    MedicalPlaceOrderUseCase(medicalRepository: ref.watch(medicalrepoProvider)));

class MedicalPlaceOrderUseCase implements IUseCase<MedicalPlaceOrderUseCaseInput, dynamic> {
